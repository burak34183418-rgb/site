...
import { ArrowRight, Award, Headphones, Shield, Globe2, TrendingUp } from 'lucide-react';
...
const Home = () => {
  ...
  const features = [
    {
      icon: Award,
      title: language === 'tr' ? '36 Yıllık Tecrübe' : language === 'en' ? '36 Years Experience' : language === 'ar' ? '36 سنة من الخبرة' : '36 лет опыта',
      description: language === 'tr' ? 'Kuyumculuk sektöründe 36 yıldır öncü, altın geri kazanımında uzman firmayız.' : language === 'en' ? 'Pioneer in jewelry industry for 36 years, expert in gold recovery.' : language === 'ar' ? 'رائد في صناعة المجوهرات لمدة 36 عامًا ، خبير في استعادة الذهب.' : 'Пионер ювелирной промышленности 36 лет, эксперт по восстановлению золота.',
      color: 'text-yellow-600',
      bgColor: 'bg-yellow-50',
    },
    {
      icon: TrendingUp,
      title: language === 'tr' ? '%99 Müşteri Memnuniyeti' : language === 'en' ? '99% Customer Satisfaction' : language === 'ar' ? '99٪ رضا العملاء' : '99% удовлетворенность клиентов',
      description: language === 'tr' ? 'Müşterilerimizin %99\'u ürünlerimizden son derece memnun ve tekrar tercih ediyor.' : language === 'en' ? '99% of our customers are extremely satisfied and prefer us again.' : language === 'ar' ? '99٪ من عملائنا راضون للغاية ويفضلوننا مرة أخرى.' : '99% наших клиентов чрезвычайно довольны и выбирают нас снова.',
      color: 'text-green-600',
      bgColor: 'bg-green-50',
    },
    {
      icon: Globe2,
      title: language === 'tr' ? 'Geri Dönüşümün Lideri' : language === 'en' ? 'Leader in Gold Recovery' : language === 'ar' ? 'رائد في استعادة الذهب' : 'Лидер восстановления золота',
      description: language === 'tr' ? 'Altın geri kazanımında sektörün lideri. Optimum verimlilik ve maksimum geri kazanım garantisi.' : language === 'en' ? 'Industry leader in gold recovery. Optimum efficiency and maximum recovery guarantee.' : language === 'ar' ? 'رائد الصناعة في استعادة الذهب. كفاءة مثالية وضمان أقصى استرداد.' : 'Лидер отрасли в восстановлении золота. Оптимальная эффективность и гарантия максимального восстановления.',
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <div className="inline-block bg-gradient-to-r from-yellow-500 to-yellow-600 text-white px-6 py-2 rounded-full text-sm font-bold mb-4">
